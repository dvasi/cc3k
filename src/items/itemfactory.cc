...
Item* ItemFactory::getPotion(){
    ...
    if (random == 1) newItem = new RHPot(Item::generateId());
    else if (random == 2) newItem = new PHPot(Item::generateId());
    else if (random == 3) newItem = new BAPot(Item::generateId());
    else if (random == 4) newItem = new BDPot(Item::generateId());
    else if (random == 5) newItem = new WAPot(Item::generateId());
    else newItem = new WDPot(Item::generateId());
